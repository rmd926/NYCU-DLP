...
#     return int(filename)
def get_key(fp):
    filename = fp.split('\\')[-1]  # Change here to correctly split on Windows path separator
    filename = filename.replace('frame', '').split('.')[0]
    return int(filename)
...
class Test_model(VAE_Model):
    ...
    def val_one_step(self, img, label, idx=0):
        ...
        for i in range(1, self.val_vi_len):#從1開始，因為第一張做為input
            ...
            # use Gaussian Predictor to get z same as valid function of trainer.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_root', '-save', type=str,   default='submit/',      help="The path to save your data")
    ...
    parser.add_argument('--ckpt_path', '-ckpt', type=str,   default=r'C:\Users\蘇柏叡\Desktop\Lab4_template\save_root\best_0.0004_34.36.ckpt', help="The path of your checkpoints")   
